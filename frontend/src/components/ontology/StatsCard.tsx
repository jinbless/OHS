  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border">
        <div className="text-xs text-gray-500 mb-1">법조항 매핑률</div>
      ...
      {/* 가이드 매핑 */}
      <div className="bg-white rounded-xl p-4 shadow-sm border">
        <div className="text-xs text-gray-500 mb-1">가이드 매핑률</div>
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border">
        ...
        <div className="text-xs text-gray-400 mt-1">
          명시 {stats.total_explicit_mappings} + 자동 {stats.total_semantic_mappings}
        </div>
      </div>

      {/* 개선율 */}
      <div className="bg-white rounded-xl p-4 shadow-sm border">
        <div className="text-xs text-gray-500 mb-1">매핑률 개선</div>
